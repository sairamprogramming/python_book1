...
# file and cakculates their total.

def main():
    # Open the video_times.txt file for reading.
    video_file = open('video_times.txt', 'r')

    # Initalize the accumulator to 0.0
    total = 0.0

    # Initalize a variable to keep count of the videos.
    count = 0

    print('Here are the running times for each video.')

    # Get the values from the file and total time.
