...
# The fucntion returns a refrence to the list.

def main():
    # Get a list with the values stored in it.
    numbers = get_values()
...
# from the users and stores them in a list. The 
# function returns a refrence to the list.
def get_values():
