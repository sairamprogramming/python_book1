# This program calculates a salesperson's salary.
def main():
    ...
    # Determine wheter the pay is negative.
    if pay < 0:
...
# The determine_comm_rate funtion accepts the
# amount of sales as an argument and return the
# applicable commision rate.
